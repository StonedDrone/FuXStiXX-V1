...
import { POWERS, SUPER_POWERS, CREATIVE_POWERS, HUGGING_FACE_POWERS, FINANCIAL_POWERS, AUTOMATION_POWERS, STREAMING_POWERS, INTEL_OPS_POWERS, ANALYTICS_POWERS, VECTOR_DRONE_POWERS } from '../constants';
...
export const PowersDropdown: React.FC<PowersDropdownProps> = ({ onPowerClick, onClose }) => {
    ...
    return (
        <div className="absolute bottom-full mb-2 w-80 max-h-[60vh] overflow-y-auto bg-layer-1 border border-layer-3 rounded-lg shadow-2xl shadow-primary/20 z-10 p-2">
           ...
           <PowerSection title="Analytics Powers" powers={ANALYTICS_POWERS} onPowerClick={handlePowerSelection} />
           <PowerSection title="Intel Ops" powers={INTEL_OPS_POWERS} onPowerClick={handlePowerSelection} />
           <PowerSection title="Automation Ops" powers={AUTOMATION_POWERS} onPowerClick={handlePowerSelection} />
           <PowerSection title="Streaming Ops" powers={STREAMING_POWERS} onPowerClick={handlePowerSelection} />
           ...
           <PowerSection title="Vector Drone Ops" powers={VECTOR_DRONE_POWERS} onPowerClick={handlePowerSelection} />
        </div>
    );
};
